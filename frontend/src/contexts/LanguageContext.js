...
const translations = {
  es: {
    ...
    ai_analyzing: "Analizando tu web... puede tardar unos segundos si el servidor está despertando.",
  ...
  en: {
    ...
    ai_analyzing: "Analyzing your website... it may take a few seconds if the server is waking up.",
